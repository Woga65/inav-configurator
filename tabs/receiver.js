        ...
        if (
            ...
            rcMapElement.innerHTML = MIXER_CONFIG.platformType == PLATFORM_HELICOPTER
                ? ` <option value="AECR12TG">Default</option>
                    <option value="CAER12TG">Collective Pitch / Spektrum (ACRO) / ELRS</option>
                    <option value="AECR12TG">Collective Pitch / Futaba (ACRO)</option>`.trim()
                : ` <option value="AETR1234">Default</option>
                    <option value="TAER1234">JR / Spektrum / Graupner / ELRS</option>
